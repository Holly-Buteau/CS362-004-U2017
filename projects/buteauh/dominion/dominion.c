...
void callVillage(int currentPlayer, struct gameState *state, int handPos)
{
	int i;
	//+3 Cards
	for (i = 0; i < 3; i++)
...
void callSteward(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2, int choice3)
{
	if (choice1 == 1)
         {
           //+2 cards
...
void callGreatHall(int currentPlayer, struct gameState *state, int handPos)
{
	   //+3 Card
	   int i;
	  for (i = 0; i < 3; i++)
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case steward:
     callSteward(currentPlayer, state, handPos, choice1, choice2, choice3);
      return 0;
