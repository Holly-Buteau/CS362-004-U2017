...
int main()
{
        ...
        printf("Should have 3 extra cards in hand and 2 extra actions\n");

        cardEffect(great_hall, 0, 0, 0, &T, 0, &bonus);
        ...
        if (T.numActions == G.numActions + 2)
                printf("Success, there are 2 extra actions to take\n");
        else
